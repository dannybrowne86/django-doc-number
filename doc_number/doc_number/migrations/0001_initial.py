...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'doc_number_document', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document_id', self.gf('django.db.models.fields.CharField')(max_length=21)),
            ('industry', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Business'])),
            ('ata', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ata_codes.ATACode'])),
            ('discipline', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('part_designator', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('serial_number', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'doc_number', ['Document'])


    def backwards(self, orm):
        # Deleting model 'Document'
        db.delete_table(u'doc_number_document')
